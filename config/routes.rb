Rails.application.routes.draw do
     ...
     post 'admin/vendors/import_csv'
     post 'admin/customers/import_csv'
     ...
     namespace :admin do
       ...
       resources :patient_shared_files
       get 'shared_files/:patient_id', to: 'patient_shared_files#shared_files', as: 'shared_files'
